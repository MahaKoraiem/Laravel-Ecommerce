...
<body class="d-flex flex-column justify-content-center align-items-center" style="height: 100vh; background: linear-gradient(0deg, rgba(34,193,195,1) 0%, rgba(253,187,45,1) 100%);">
    ...
    <div class="container h-75 d-flex flex-column justify-content-around w-50 border p-3">
        ...
        <div class="row g-3 mb-2">
            <h1 class="col-12 display-3 text-center text-dark">Registeration Form</h1>
        </div>
        ...
        <form class="row g-3" action="{{ route('register') }}" method="post">
            ...
            <div class="col-12 mb-2">
                <label for="name" class="form-label text-dark ms-3 fw-bold">Username</label>
            ...
            <div class="col-12 mb-2">
                <label for="email" class="form-label text-dark ms-3 fw-bold">Email address</label>
            ...
            <div class="col-12 mb-2">
                <label for="password_confirmation" class="form-label text-dark ms-3 fw-bold">Confirm Password</label>
